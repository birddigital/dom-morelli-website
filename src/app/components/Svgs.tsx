...
// Spotify Icon Component (Standardized with same stroke width)
export const SpotifySVG: React.FC = () => (
  <span className="[&>svg]:h-5 [&>svg]:w-5">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const SoundCloudSVG: React.FC = () => (
  <span className="[&>svg]:h-5 [&>svg]:w-5">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const AppleMusicSVG: React.FC = () => (
  <span className="[&>svg]:h-5 [&>svg]:w-5">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const YouTubeSVG: React.FC = () => (
  <span className="[&>svg]:h-5 [&>svg]:w-5">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
